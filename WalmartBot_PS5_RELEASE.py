...
def order(driver, myFirstName, myLastName, myEmail, myAddress, myPhone, myCreditCardNum, myCreditExpireMonth,
    ...
    checkOut = '//*[@id="cart-root-container-content-skip"]/div[1]/div/div[2]/div/div/div/div/div[3]/div/div/div[' \
               '2]/div/div[2]/div/button[1] '
    username = '//*[@id="sign-in-email"]'
    password = '/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[1]/div/div/div/div/div[3]/div/div[' \
               '4]/div/section/div/section/form/div[2]/div/div[1]/label/div[2]/div/input '
    continueWithAccount = '/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[1]/div/div/div/div/div[' \
                          '3]/div/div[4]/div/section/div/section/form/div[5]/button/span '
    firstContinue = '/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[2]/div/div[2]/div/div/div/div[' \
                    '3]/div/div/div[2]/button/span '
    firstName = '//*[@id="firstName"]'
    lastName = '//*[@id="lastName"]'
    email = '//*[@id="email"]'
    address = '//*[@id="addressLineOne"]'
    phone = '//*[@id="phone"]'
    confirmInfo = '/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[3]/div[1]/div[2]/div/div/div/div[' \
                  '3]/div/div/div/div/div/form/div[2]/div[2]/button/span '
    creditCardNum = '//*[@id="creditCard"]'
    creditExpireMonth = '//*[@id="month-chooser"]'
    creditExpireYear = '//*[@id="year-chooser"]'
    creditCVV = '//*[@id="cvv"]'
    reviewOrder = '/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div/div[4]/div[1]/div[2]/div/div/div/div[' \
                  '3]/div[2]/div/div/div/div[2]/div/div/div/form/div[3]/div/button/span/span/span '
    confirmOrder = '/html/body/div[1]/div/div[1]/div/div[1]/div[3]/div/div/div[2]/div[1]/div[2]/div/div/div[' \
                   '2]/div/form/div/button '
...
def PlayStationDigital(myFirstName, myLastName, myEmail, myAddress, myPhone, myCreditCardNum, myCreditExpireMonth,
...
def PlayStationPhysical(myFirstName, myLastName, myEmail, myAddress, myPhone, myCreditCardNum, myCreditExpireMonth,
                        myCreditExpireYear, myCVV, supplier, myUsername, myPassword):
    messagebox.showinfo('Message',
                        'Bot has been turned on. Press "Okay" to continue and the Playstation bot will run. This '
                        'application may stop responding as it runs, but it will continue to run the scripts')
...
def form(console, supplier):
    ...
    if console == "PS":
        if supplier == "Walmart":
            ps5P = Button(root, text="Playstation Physical",
                          command=partial(PlayStationPhysical, myFirstName, myLastName, myEmail, myAddress, myPhone,
                                          myCreditCardNum, myCreditExpireMonth, myCreditExpireYear, myCVV, "Walmart",
                                          myUsername, myPassword))
            ps5D = Button(root, text="Playstation Digital",
                          command=partial(PlayStationDigital, myFirstName, myLastName, myEmail, myAddress, myPhone,
                                          myCreditCardNum, myCreditExpireMonth, myCreditExpireYear, myCVV, "Walmart",
                                          myUsername, myPassword))
    ...
    if console == "XB":
        ps5P = Button(root, text="Xbox Series X",
                      command=partial(XboxX, myFirstName, myLastName, myEmail, myAddress, myPhone, myCreditCardNum,
                                      myCreditExpireMonth, myCreditExpireYear, myCVV, "Walmart", myUsername,
                                      myPassword))
        ps5D = Button(root, text="Xbox Series S",
                      command=partial(XboxS, myFirstName, myLastName, myEmail, myAddress, myPhone, myCreditCardNum,
                                      myCreditExpireMonth, myCreditExpireYear, myCVV, "Walmart", myUsername,
                                      myPassword))
        ps5P.grid(column=0, row=65)
        ps5D.grid(column=1, row=65)
